...
public class CheckBoxView extends View implements Checkable {
    ...
    public CheckBoxView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundPaintTrue.setColor(context.getResources().getColor(R.color.colorBlue));
        mBackgroundPaintTrue.setStyle(Paint.Style.FILL);

        mBackgroundPaintFalse = new Paint();
        mBackgroundPaintFalse.setAntiAlias(true);
        mBackgroundPaintFalse.setColor(context.getResources().getColor(R.color.bg_common));
        ...
        if (attrs != null) {
            ...
            int trueColor = array.getColor(R.styleable.CheckBoxView_trueColor, context.getResources().getColor(R.color.colorBlue));
