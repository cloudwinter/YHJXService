...
public class CancelDialog extends Dialog {
    ...
    private EditText edit_reason;//输入取消原因
    ...
    private void initEvent() {
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String editText = edit_reason.getText().toString();
                if (TextUtils.isEmpty(editText)) {
                    ToastUtils.showToast(mContext,"请输入取消原因");
                    return;
                }
                if (yesOnclickListener != null) {
                    yesOnclickListener.onYesClick(edit_reason.getText().toString());
                }
            }
        });
    ...
    private void initData() {
        ...
        if (messageStr != null) {
            edit_reason.setText(messageStr);
        }
        //如果设置按钮的文字
        if (yesStr != null) {
            yes.setText(yesStr);
